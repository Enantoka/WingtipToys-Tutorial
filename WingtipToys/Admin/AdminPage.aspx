...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownAddCategory" runat="server" ItemType="WingtipToys.Models.Category" SelectMethod="GetCategories"
        ...
        <tr>
            ...
            <td><asp:TextBox ID="AddProductName" runat="server"></asp:TextBox>
        ...
        <tr>
            ...
            <td><asp:FileUpload ID="ProductImage" runat="server" />
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="WingtipToys.Models.Product" SelectMethod="GetProducts"
